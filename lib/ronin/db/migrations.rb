...
require 'ronin/db/migrations/graph'
...
require 'ronin/db/migrations/arch'
require 'ronin/db/migrations/country'
require 'ronin/db/migrations/credential'
require 'ronin/db/migrations/email_address'
require 'ronin/db/migrations/host_name'
require 'ronin/db/migrations/mac_address'
require 'ronin/db/migrations/open_port'
require 'ronin/db/migrations/organization'
require 'ronin/db/migrations/os_guess'
...
require 'ronin/db/migrations/service'
require 'ronin/db/migrations/software'
require 'ronin/db/migrations/url_query_param_name'
require 'ronin/db/migrations/url_query_param'
require 'ronin/db/migrations/url'
require 'ronin/db/migrations/url_scheme'
